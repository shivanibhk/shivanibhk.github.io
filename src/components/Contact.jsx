  ...
  return (
    <div className="xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 overflow-hidden">
      ...
      >
        ...
        >
        I am currently looking for new grad opportunities related to software engineering or artificial intelligence. Feel free to connect with me on LinkedIn or drop me an email at shivanihukkeri@gmail.com!
        </p>
